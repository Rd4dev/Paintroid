package org.catrobat.paintroid.test.data.local
...
class ProjectDaoTest {
    ...
    fun updateProjectUri() {
        val project = Project(
            ...
            "paintroid/path",
            1)
        Log.d("checking", "updateProjectUri: $project")
        dao.insertProject(project)
        dao.updateProjectUri(
            "name",
            "paintroid/upath",
            "catrobat/upath",
            1)
        val allProjects = dao.getProjects()
        Log.d("checking", "updateProjectUri: $allProjects")
        ...
        Log.d("checking", "updateProjectUri: ${updatedProject?.lastModified == 1L}")
